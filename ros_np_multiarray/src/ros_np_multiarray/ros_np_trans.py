...
#         pass
#     def to_multiarray_f32(self):
#         partial(_numpy_to_multiarray, Float32MultiArray)
#     def to_numpy_f32(self):
#         partial(_multiarray_to_numpy, float, np.float32)
#     def to_multiarray_f64(self):
#         partial(_numpy_to_multiarray, Float64MultiArray)
#     def to_numpy_f64(self):
#         partial(_multiarray_to_numpy, float, np.float64)
#     def to_multiarray_i8(self):
#         partial(_numpy_to_multiarray, Int8MultiArray)
#     def to_numpy_i8(self):
#         partial(_multiarray_to_numpy, int, np.int8)
#     def to_multiarray_i16(self):
#         partial(_numpy_to_multiarray, Int16MultiArray)
#     def to_numpy_i16(self):
#         partial(_multiarray_to_numpy, int, np.int16)
#     def to_multiarray_i32(self):
#         partial(_numpy_to_multiarray, Int32MultiArray)
#     def to_numpy_i32(self):
#         partial(_multiarray_to_numpy, int, np.int32)
#     def to_multiarray_i64(self):
#         partial(_numpy_to_multiarray, Int64MultiArray)
#     def to_numpy_i64(self):
#         partial(_multiarray_to_numpy, int, np.int64)
#     def to_multiarray_u8(self):
#         partial(_numpy_to_multiarray, UInt8MultiArray)
#     def to_numpy_u8(self):
#         partial(_multiarray_to_numpy, int, np.uint8)
#     def to_multiarray_u16(self):
#         partial(_numpy_to_multiarray, UInt16MultiArray)
#     def to_numpy_u16(self):
#         partial(_multiarray_to_numpy, int, np.uint16)
#     def to_multiarray_u32(self):
#         partial(_numpy_to_multiarray, UInt32MultiArray)
#     def to_numpy_u32(self):
#         partial(_multiarray_to_numpy, int, np.uint32)
#     def to_multiarray_u64(self):
#         partial(_numpy_to_multiarray, UInt64MultiArray)
#     def to_numpy_u64(self):
#         partial(_multiarray_to_numpy, int, np.uint64)
